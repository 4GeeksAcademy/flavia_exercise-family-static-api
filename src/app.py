...
def add_member():
    ...
    if 'first_name' not in body:
        return jsonify({'message': 'Specify first_name'}), 400
    if 'age' not in body:
        return jsonify({'message': 'Specify age'}), 400
    if 'lucky_numbers' not in body:
        return jsonify({'message': 'Specify lucky_numbers'}), 400
    ...
    return jsonify({'New member': new_member}), 200
